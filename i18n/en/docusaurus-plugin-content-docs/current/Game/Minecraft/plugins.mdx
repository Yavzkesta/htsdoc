---
sidebar_position: 2
title: Adding a Plugin on a Minecraft Server
description: Instructions to add plugins on a Minecraft server, with specific steps for Spigot, Paper, Mohist, and other compatible servers
keywords:
  - Minecraft
  - Plugins
  - Spigot
...
If you have any questions, feel free to join our Discord server at [discord.gg/hebergtonserv](https://discord.gg/hebergtonserv).
