---
sidebar_position: 1
title: Assuming a Client Role on Discord
description: Step-by-step guide to assume a client role on a Discord server, allowing access to specific features
keywords:
  - Discord
  - client role
  - user guide
